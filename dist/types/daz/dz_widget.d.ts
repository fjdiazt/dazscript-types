declare class DzWidget extends QObject {
    ...
    hide(): any;
    mapFrom(p0: DzWidget, p1: Point): any;
    mapFromGlobal(p0: Point): any;
    mapFromParent(p0: Point): any;
    mapTo(p0: DzWidget, p1: Point): any;
    mapToGlobal(p0: Point): any;
    mapToParent(p0: Point): any;
    reparent(parent: DzWidget, position: Point): any;
    reparent(parent: DzWidget, position: Point, show: boolean): any;
