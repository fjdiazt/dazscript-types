declare class DzElidedLabel extends DzLabel {
    ...
    inherits(): any;
    linkActivated(p0: QString): void;
    linkHovered(p0: QString): void;
    setDisabled(p0: boolean): void;
    setEnabled(p0: boolean): void;
    setHidden(p0: boolean): any;
    setMovie(p0: QMovie): any;
    setNum(p0: number): any;
    setNum(p0: number): any;
    setPicture(p0: QPicture): any;
    setPixmap(p0: QPixmap): any;
