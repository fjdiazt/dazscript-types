declare class DzElementSideNavHierarchy {

    // Properties
    objectName: string; // DrawSettingsPropertiesWgt
    modal: boolean; // false
    ...
    name: string; // DrawSettingsPropertiesWgt
    ...
    getEditMode(): any;
    getElement(p0: number): any;
    getFilterNavigationBar(): any;
    getGuidePage(): any;
    getNavDivider(): any;
    getNumElements(): number;
    getPropertySelections(): any;
    getPropertySelections(p0: boolean): any;
    getPropertyView(): any;
    getRecurseChildrenGroups(): any;
    getSelectorWgt(): any;
    ...
    setFilter(p0: string): any;
    setFocus(): any;
    setHidden(p0: boolean): any;
    setRecurseChildrenGroups(p0: boolean): any;
    ...
    // Signals
    hasItemsChanged(p0: boolean): any;
