declare class DzFileContentTab extends DzContentTab {

    // Properties
    objectName: string; // SmartContentFileContentTab
    modal: boolean; // false
    ...
    name: string; // SmartContentFileContentTab
