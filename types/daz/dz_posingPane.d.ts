declare class DzPosingPane extends DzAbstractNodeEditorPane {

    // Properties
    objectName: string; // Posing
    modal: boolean; // false
    windowModality: number; // 0
    enabled: boolean; // true
    geometry: any; // [object Object]
    ...
    minimumWidth: number; // 297
    minimumHeight: number; // 212
    ...
    handleTabWidgetChanged(p0:number): any;
}